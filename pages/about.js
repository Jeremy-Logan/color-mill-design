		...
		<>
			...
			<main>
				<section className='mt-36 mx-[5vw] md:mx-[15vw] overflow-hidden'>
					<h1 className='font-serif font-bold text-3xl md:text-6xl '>
						Hello, we are Color Mill Design
					</h1>
					<h2 className='font-serif text-2xl mt-4 md:mt-12'>
					...
					<h3 className='text-md md:text-lg lg:text-xl leading-relaxed mt-12 '>
						...
						<br />
						<br />
						We are small enough to be personally involved with every
						one of our clients and nimble enough to deliver what we
						say we will.{' '}
					</h3>
