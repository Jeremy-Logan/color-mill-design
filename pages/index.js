		...
		<div>
			...
			<main className='overflow-hidden'>
				...
				<div className='h-[4000px] '>
					<div className='flex'>
						<div className='w-1/3 my-auto mr-24'>
							<h3 className='text-5xl font-bold my-auto text-center '>
								Mendocino Spirits
							</h3>
              <h4 className='text-lg text-center'>Banding, Package Design, Web Design, </h4>
						</div>
						<img
							className=' h-[600px] z-30'
